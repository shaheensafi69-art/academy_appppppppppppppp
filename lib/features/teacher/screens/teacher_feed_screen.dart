                      ...
                      ? ListView(
                          ...
                          children: [
                            ...
                            Center(
                              child: Column(
                                children: [
                                  Icon(Icons.search_off_rounded, size: 60, color: textGrey.withOpacity(0.5)),
                                  const SizedBox(height: 16),
                                  const Text("No posts found.", style: TextStyle(color: textGrey, fontSize: 16, fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                          ],
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: _searchController.text.isNotEmpty
                                    ? IconButton(
                                        icon: const Icon(Icons.close_rounded, color: textGrey, size: 18),
                                        onPressed: () {
                ...
                GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: primaryPink.withOpacity(0.2), width: 2),
                    ),
                    child: CircleAvatar(
                      radius: 20,
                      ...
                      child: post.authorAvatar.isEmpty
                          ? Text(post.authorName.isNotEmpty ? post.authorName[0] : 'U', style: const TextStyle(color: primaryPink, fontWeight: FontWeight.bold, fontSize: 16))
                          : null,
                    ),
                  ),
                ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(post.createdAt.isNotEmpty ? post.createdAt.split('T')[0] : '', style: const TextStyle(color: textGrey, fontSize: 11, fontWeight: FontWeight.w600)),
                          ],
                        ),
                      ],
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text("Like", style: TextStyle(color: post.isLikedByMe ? primaryPink : textGrey, fontWeight: FontWeight.bold, fontSize: 13)),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Row(
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: const Text("Reply", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w900, color: Color(0xFF6B7280))),
                          ),
                        ],
                      ),
                    ),
