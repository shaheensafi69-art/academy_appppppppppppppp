...
class _StoryViewerScreenState extends State<StoryViewerScreen> with SingleTickerProviderStateMixin {
    ...
    try {
      ...
      if (loaded.isEmpty) {
        ...
        loaded.add(StoryItemData(
          ...
          mediaType: "image",
          caption: "خوشحالم که در کلاس تحلیل بازارهای مالی آکادمی صافی شرکت کردم! 🚀",
  ...
  void _startStoryTimer() {
    ...
    const totalDurationMs = 5000.0; // ۵ ثانیه برای هر استوری
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: widget.userAvatar.isEmpty
                        ? Text(widget.userName.isNotEmpty ? widget.userName[0] : 'U', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold))
                        : null,
                  ),
