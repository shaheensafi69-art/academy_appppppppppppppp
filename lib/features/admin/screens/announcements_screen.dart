  ...
  Future<void> handleBroadcast() async {
    if (titleCtrl.text.trim().isEmpty || messageCtrl.text.trim().isEmpty) {
      setState(() {
        toastMessage = {
          'type': 'error',
          'text': context.l10n.fillRequiredFields,
        };
      });
      return;
    }
    ...
    try {
      ...
      setState(() {
        ...
        toastMessage = {
          'type': 'success',
          'text': context.l10n.publishAnnouncement,
        };
        titleCtrl.clear();
        messageCtrl.clear();
        targetRole = "all";
      ...
      setState(() {
        toastMessage = {'type': 'error', 'text': e.toString()};
      });
    } finally {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          context.l10n.announcementBroadcast,
                          style: const TextStyle(
                            fontSize: 8,
                            fontWeight: FontWeight.w900,
                            color: primaryPink,
                  ...
                  Text(
                    context.l10n.announcementsSubtitle,
                    style: const TextStyle(
                      fontSize: 11,
                      color: textGrey,
                      fontWeight: FontWeight.w500,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    context.l10n.publishAnnouncement,
                    style: const TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.w900,
                      color: textGrey,
                  ...
                  // Title Field
                  Text(
                    "${context.l10n.announcementTitle.toUpperCase()} *",
                    style: const TextStyle(
                      fontSize: 9,
                      fontWeight: FontWeight.w900,
                      color: textGrey,
                  ...
                  Text(
                    "${context.l10n.announcementContent.toUpperCase()} *",
                    style: const TextStyle(
                      fontSize: 9,
                      fontWeight: FontWeight.w900,
                      color: textGrey,
            ...
            Row(
              children: [
                Text(
                  context.l10n.recentAnnouncements.toUpperCase(),
                  style: const TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
                    color: textGrey,
