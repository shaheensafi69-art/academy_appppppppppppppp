        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                context.l10n.loadingCourseDetails,
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text(context.l10n.courseNotFound, style: const TextStyle(color: textDark, fontWeight: FontWeight.bold)),
              const SizedBox(height: 14),
              ElevatedButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          (course!['category'] ?? context.l10n.course).toString().toUpperCase(),
                          style: const TextStyle(fontSize: 8, fontWeight: FontWeight.w900, color: primaryPink, letterSpacing: 1.2),
                        ),
                      ),
                      Text(
                        price > 0 ? "\$${price.toStringAsFixed(2)}" : context.l10n.free,
                  ...
                  Text(course!['description'] ?? context.l10n.noDescription, style: const TextStyle(fontSize: 11, color: textGrey, fontWeight: FontWeight.w500)),
                  ...
                  if (teacher != null) ...[
                    Row(
                      children: [
                        ...
                        Text("${context.l10n.teacher}: ${teacher['first_name'] ?? ''} ${teacher['last_name'] ?? ''}".trim(), style: const TextStyle(color: textDark, fontSize: 11, fontWeight: FontWeight.bold)),
                      ],
                    ),
                    const SizedBox(height: 14),
                  ],
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildMiniStat(context.l10n.enrolledStudents, students.length.toString(), Icons.group_rounded)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildMiniStat(context.l10n.language, course!['language'] ?? 'English', Icons.language_rounded)),
                    ],
                  )
                ],
              ),
            ...
            Text(context.l10n.studentRegistry, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: textGrey, letterSpacing: 1.5)),
            const SizedBox(height: 12),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(context.l10n.activeCohort, style: TextStyle(color: Colors.green.shade700, fontSize: 9, fontWeight: FontWeight.w900)),
                            ),
                          ],
                        ),
                      );
