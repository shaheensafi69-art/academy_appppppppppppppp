...
class LiveClassItem {
  ...
  factory LiveClassItem.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, dynamic>? formattedCourse = courseObj is List
        ? (courseObj.isNotEmpty ? courseObj[0] : null)
        : courseObj;

    final teacherObj = json['teacher'];
    Map<String, dynamic>? formattedTeacher = teacherObj is List
        ? (teacherObj.isNotEmpty ? teacherObj[0] : null)
        : teacherObj;
...
class _LiveClassesScreenState extends State<LiveClassesScreen> {
  ...
  Future<void> _fetchLiveClasses() async {
    ...
    try {
      final response = await supabase
          .from("class_groups")
          .select(
            "id, class_name, is_active, class_time, class_days, schedule_info, start_date, end_date, meeting_link, signal_group_link, course:courses(title), teacher:profiles!teacher_id(first_name, last_name, avatar_url)",
          )
      ...
      if (mounted) {
        setState(() {
          classes = (response as List)
              .map((c) => LiveClassItem.fromJson(c))
              .toList();
          isLoading = false;
        });
      }
  ...
  Future<void> handleUpdateClassDetails() async {
    ...
    try {
      ...
      String? newTime = classTimeCtrl.text.trim().isNotEmpty
          ? classTimeCtrl.text.trim()
          : null;
      String? newDays = classDaysCtrl.text.trim().isNotEmpty
          ? classDaysCtrl.text.trim()
          : null;
      String? newSchedule = scheduleInfoCtrl.text.trim().isNotEmpty
          ? scheduleInfoCtrl.text.trim()
          : null;
      String? newMeeting = meetingLinkCtrl.text.trim().isNotEmpty
          ? meetingLinkCtrl.text.trim()
          : null;
      String? newSignal = signalLinkCtrl.text.trim().isNotEmpty
          ? signalLinkCtrl.text.trim()
          : null;
      ...
      setState(() {
        ...
        message = {'type': 'success', 'text': context.l10n.saveClassChanges};
      });
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                context.l10n.establishingConnection,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          context.l10n.liveStreamingStudio,
                          style: const TextStyle(
                            fontSize: 8,
                            fontWeight: FontWeight.w900,
                            color: primaryPink,
                  ...
                  Text(
                    context.l10n.liveSessionsAndCohorts,
                    style: const TextStyle(
                      fontSize: 22,
                      fontWeight: FontWeight.w900,
                      color: textDark,
                  ...
                  Text(
                    context.l10n.liveSessionsSubtitle,
                    style: const TextStyle(
                      fontSize: 11,
                      color: textGrey,
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: context.l10n.searchCohortsHint,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                if (cls.classDays != null &&
                                    cls.classDays!.isNotEmpty) ...[
                                  const SizedBox(width: 10),
                                  Expanded(
                                    child: Row(
                                      children: [
                            ...
                            if (cls.classTime != null &&
                                cls.classTime!.isNotEmpty)
                              Row(
                                children: [
                                  const Icon(
                                ...
                                Expanded(
                                  child: ElevatedButton.icon(
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: cls.meetingLink != null
                                          ? lightPinkBg
                                          : cardBorder,
                                      foregroundColor: cls.meetingLink != null
                                          ? primaryPink
                                          : textGrey,
                                      elevation: 0,
                                      padding: const EdgeInsets.symmetric(
                                    ...
                                    label: Text(
                                      cls.meetingLink != null
                                          ? context.l10n.joinMeeting
                                          : context.l10n.noLink,
                                      style: const TextStyle(
                                        fontSize: 11,
                                        fontWeight: FontWeight.w900,
                                    ...
                                    onPressed: cls.meetingLink != null
                                        ? () => _launchURL(cls.meetingLink!)
                                        : null,
                                  ),
                                ),
                                const SizedBox(width: 10),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            "${context.l10n.manageClassModal}: ${selectedClass!.className}",
                            style: const TextStyle(
                              color: textDark,
                              fontWeight: FontWeight.w900,
                              fontSize: 14,
                    ...
                    TextField(
                      ...
                      decoration: _inputDecoration("e.g. Cohort Alpha"),
                    ),
                    const SizedBox(height: 14),
                    ...
                    TextField(
                      ...
                      decoration: _inputDecoration(context.l10n.signalLinkHint),
                    ),
                    const SizedBox(height: 14),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (val) =>
                              setState(() => isClassActiveModal = val),
                        ),
                      ],
                    ),
