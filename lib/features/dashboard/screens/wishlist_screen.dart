      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            Text(context.l10n.wishlist, style: const TextStyle(color: textDark, fontWeight: FontWeight.w900, fontSize: 14)),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("${context.l10n.instructor}: ${item.instructorName}", style: const TextStyle(color: textGrey, fontSize: 10, fontWeight: FontWeight.bold)),
