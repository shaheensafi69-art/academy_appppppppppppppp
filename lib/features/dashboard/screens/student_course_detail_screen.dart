...
class _StudentCourseDetailScreenState extends State<StudentCourseDetailScreen> {
  ...
  Future<void> _handleRegistrationSubmit() async {
    ...
    try {
      ...
      // اگر گروه کلاسی انتخاب شده بود، دانشجو را در کلاس مربوطه ثبت‌نام می‌کنیم
      if (selectedClassGroupId.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    if (instructorOptions.isEmpty) {
      instructorOptions.add("Safi Academy Faculty");
    }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Submit Registration Button (بدون شکستن متن و با طراحی حرفه‌ای)
                          SizedBox(
                            width: double.infinity,
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
